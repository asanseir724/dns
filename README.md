...
برای گزارش مشکلات یا پیشنهادات، لطفاً موارد زیر را ارسال کنید:

#### اطلاعات سیستم:
- نسخه سیستم عامل (Ubuntu/Debian/CentOS)
- نسخه Docker (برای DNS Project)
- نسخه اسکریپت‌ها

#### اطلاعات خطا:
- لاگ‌های خطا کامل
- تنظیمات کانفیگ
- مراحل انجام شده قبل از خطا

#### راه‌های ارتباط:
- [GitHub Issues](https://github.com/asanseir724/dns/issues)
- [GitHub Discussions](https://github.com/asanseir724/dns/discussions)

### 📚 **مستندات بیشتر**

- [DNS Project README](dns-project/README.md) - راهنمای کامل DNS Project
- [Tunnel Project README](tunnel-project/TUNNEL_README.md) - راهنمای کامل Tunnel Project
- [GitHub Setup Guide](GITHUB_SETUP.md) - راهنمای تنظیم GitHub
...
**ساخته شده با ❤️ توسط [asanseir724](https://github.com/asanseir724)**
