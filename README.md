...
1) سرور ایران (کلاینت) - برای اتصال به سرور خارج
2) سرور خارج (سرور) - برای دریافت اتصال از سرور ایران

نوع سرور شما (1 یا 2): 
```

#### 2. **برای سرور ایران - وارد کردن اطلاعات سرور خارج:**
```
=== اطلاعات سرور خارج ===
...
#### 3. **برای سرور خارج - تنظیمات پیش‌فرض:**
```
=== تنظیمات سرور خارج ===
تنظیمات پیش‌فرض برای سرور خارج:
✅ تنظیمات پیش‌فرض سرور خارج اعمال شد
```
